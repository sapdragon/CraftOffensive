...
public:
	...
	ISteamClient *SteamClient() const					{ return g_pSteamClient; }
	...
	ISteamHTTP *SteamHTTP() const						{ return g_pSteamHTTP; }
	ISteamInventory *SteamInventory() const				{ return g_pSteamInventory; }
...
private:
	...
	ISteamInventory				*g_pSteamInventory;
...
inline bool CSteamGameServerAPIContext::Init()
{
	...
	m_pSteamGameServer = g_pSteamClient->GetISteamGameServer( hSteamUser, hSteamPipe, STEAMGAMESERVER_INTERFACE_VERSION );
	if ( !m_pSteamGameServer )
		return false;

	m_pSteamGameServerUtils = g_pSteamClient->GetISteamUtils( hSteamPipe, STEAMUTILS_INTERFACE_VERSION );
	if ( !m_pSteamGameServerUtils )
		return false;

	m_pSteamGameServerNetworking = g_pSteamClient->GetISteamNetworking( hSteamUser, hSteamPipe, STEAMNETWORKING_INTERFACE_VERSION );
	if ( !m_pSteamGameServerNetworking )
		return false;

	m_pSteamGameServerStats = g_pSteamClient->GetISteamGameServerStats( hSteamUser, hSteamPipe, STEAMGAMESERVERSTATS_INTERFACE_VERSION );
