...
#define STEAMMATCHMAKING_INTERFACE_VERSION _( "SteamMatchMaking009" )
...
#define STEAMMATCHMAKINGSERVERS_INTERFACE_VERSION S_( "SteamMatchMakingServers002" )
...
#define BChatMemberStateChangeRemoved( rgfChatMemberStateChangeFlags ) ( rgfChatMemberStateChangeFlags & ( k_EChatMemberStateChangeDisconnected | k_EChatMemberStateChangeLeft | k_EChatMemberStateChangeKicked | k_EChatMemberStateChangeBanned ) ) //-V1003
