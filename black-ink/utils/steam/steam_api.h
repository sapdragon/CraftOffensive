...
public:
	...
	ISteamUser*			SteamUser() const					{ return g_pSteamUser; }
	ISteamFriends*		SteamFriends() const				{ return g_pSteamFriends; }
	ISteamUtils*		SteamUtils() const					{ return m_pSteamUtils; }
	ISteamMatchmaking*	SteamMatchmaking() const			{ return g_pSteamMatchMaking; }
	ISteamUserStats*	SteamUserStats() const				{ return g_pSteamUserStats; }
	ISteamApps*			SteamApps() const					{ return m_pSteamApps; }
	ISteamMatchmakingServers* SteamMatchmakingServers() const { return g_pSteamMatchMakingServers; }
...
private:
	...
	ISteamMatchmaking	*g_pSteamMatchMaking;
	ISteamUserStats		*g_pSteamUserStats;
	ISteamApps			*m_pSteamApps;
	ISteamMatchmakingServers *g_pSteamMatchMakingServers;
