...
public:
	...
	VFUNC(think(), 139, void(__thiscall*)(void*))
	VFUNC(pre_think(), 318, void(__thiscall*)(void*))
	VFUNC(post_think(), 319, void(__thiscall*)(void*))
	VFUNC(select_item(const char* name, int sub_type), 330, void(__thiscall*)(void*, const char*, int), name, sub_type)
	VFUNC(update_collistion_bounds(), 340, void(__thiscall*)(void*))
